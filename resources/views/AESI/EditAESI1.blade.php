...
'                            <label>'+
'                              <input type="checkbox" id="fainting1" name="c_fainting[' + rowCountSyntom + ']"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Fainting'+
'                            </label>'+
...
'                            <label>'+
'                              <input type="checkbox" id="headche1" name="c_headche[' + rowCountSyntom + ']"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Headche'+
'                            </label>'+
...
'                            <label>'+
'                              <input type="checkbox" id="diarrhea" name="c_diarrhea[' + rowCountSyntom + ']"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Diarrhea'+
'                            </label>'+
...
'                            <label>'+
'                              <input type="checkbox" id="arthalgia1" name="c_arthalgia[' + rowCountSyntom + ']"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Arthalgia'+
'                            </label>'+
...
'                              <label>'+
'                                <input type="checkbox" id="swelling_at_the_injection1" name="c_swelling_at_the_injection[' + rowCountSyntom + ']"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                                บวมบริเวณที่ฉีดนานเกิน3วัน'+
'                              </label>'+
...
'                              <label>'+
'                                <input type="checkbox" id="swelling_beyond_nearest_joint1" name="c_swelling_beyond_nearest_joint[' + rowCountSyntom + ']"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                                บวมลามไปถึงข้อที่ใกล้ที่สุด'+
'                              </label>'+
...
'                              <label>'+
'                                <input type="checkbox" id="bacterial_abscess1" name="c_bacterial_abscess[' + rowCountSyntom + ']"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                                Bacterial abscess'+
'                              </label>'+
...
'                            <label>'+
'                              <input type="checkbox" id="febrile_convulsion1" name="c_febrile_convulsion[' + rowCountSyntom + ']"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Febrile convulsion'+
'                            </label>'+
...
'                            <label>'+
'                              <input type="checkbox" id="afebrile_convulsion" name="c_afebrile_convulsion[' + rowCountSyntom + ']"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Afebrile convulsion'+
'                            </label>'+
...
'                            <label>'+
'                              <input id="persistent_inconsolable_crying1" name="c_persistent_inconsolable_crying[' + rowCountSyntom + ']" type="checkbox"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Persistent inconsolable crying'+
'                            </label>'+
...
'                            <label>'+
'                              <input id="toxic_shock_syndrome1" name="c_toxic_shock_syndrome[' + rowCountSyntom + ']" type="checkbox"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Toxic shock syndrome'+
'                            </label>'+
...
'                            <label>'+
'                              <input id="gbs" name="c_gbs[' + rowCountSyntom + ']" type="checkbox"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Guillain-Barré syndrome (GBS)'+
'                            </label>'+
...
'                            <label>'+
'                              <input id="transverse myelitis1" name="c_transverse myelitis[' + rowCountSyntom + ']" type="checkbox"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Transverse myelitis'+
'                            </label>'+
...
'                            <label>'+
'                              <input id="adem1" name="c_adem[' + rowCountSyntom + ']" type="checkbox"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Acute disseminated encephalomyelitis (ADEM)'+
'                            </label>'+
...
'                            <label>'+
'                              <input id="acute_myocardial1" name="c_acute_myocardial[' + rowCountSyntom + ']" type="checkbox"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Acute Myocardial'+
'                            </label>'+
...
'                            <label>'+
'                              <input id="ards1" name="c_ards[' + rowCountSyntom + ']" type="checkbox"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                               Acute respiratory distress syndrome (ARDS)'+
'                            </label>'+
...
'                            <label>'+
'                              <input name="c_chest_pain[' + rowCountSyntom + ']" type="checkbox"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Chest pain'+
'                            </label>'+
...
'                            <label>'+
'                              <input name="c_myocarditis[' + rowCountSyntom + ']" type="checkbox"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Myocarditis'+
'                            </label>'+
...
'                            <label>'+
'                              <input name="c_heart_failure[' + rowCountSyntom + ']" type="checkbox"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Heart failure'+
'                            </label>'+
...
'                            <label>'+
'                              <input name="c_pericarditis[' + rowCountSyntom + ']" type="checkbox"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Pericarditis'+
'                            </label>'+
...
'                            <label>'+
'                              <input name="c_sudden_cardiac_arrest[' + rowCountSyntom + ']" type="checkbox"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Sudden cardiac arrest'+
'                            </label>'+
...
'                            <label>'+
'                              <input name="c_covid_19[' + rowCountSyntom + ']" type="checkbox"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Covid-19'+
'                            </label>'+
...
'                            <label>'+
'                              <input name="c_ischemic_stroke[' + rowCountSyntom + ']" type="checkbox"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Ischemic stroke'+
'                            </label>'+
...
'                            <label>'+
'                              <input name="c_hemorrhagic_stroke[' + rowCountSyntom + ']" type="checkbox"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                            Hemorrhagic stroke'+
'                            </label>'+
...
'                            <label>'+
'                              <input name="c_deep_vein_thrombosis[' + rowCountSyntom + ']" type="checkbox"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Deep vein thrombosis                            '+
'		                      	</label>'+
...
'                            <label>'+
'                              <input name="c_pulmonary_embolism[' + rowCountSyntom + ']" type="checkbox"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Pulmonary embolism'+
'                            </label>'+
...
'                            <label>'+
'                              <input name="c_hypertension[' + rowCountSyntom + ']" type="checkbox"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Hypertension'+
'                            </label>'+
...
'                            <label>'+
'                              <input name="c_hypertensive_urgency[' + rowCountSyntom + ']" type="checkbox"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                               Hypertensive urgency'+
'                            </label>'+
...
'                            <label>'+
'                              <input name="c_bells_palsy[' + rowCountSyntom + ']" type="checkbox"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                              Bells palsy'+
'                            </label>'+
...
'                      <div class="col-md-4">'+
'                        <label>'+
'                          <input type="checkbox" name="c_other_seriousness_of_the_symptoms[' + rowCountSyntom + ']" id="other_seriousness_of_the_symptoms1"  value="1" @if($data[0]->title_name == 0) checked @else @endif>'+
'                          เสียชีวิต'+
'                        </label>'+
'                      </div>'+
'                      <div class="col-md-4">'+
