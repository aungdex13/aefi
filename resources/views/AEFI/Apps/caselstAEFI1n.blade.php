  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title"><a href="{{ route('form1n') }}" type="button" class="btn btn-success btn-flat" target="_blank"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>เพิ่มผู้ป่วย AEFI ราย Case</a></h3>
        </div>
      <div class="box-header with-border">
    ...
    @if ($roleArrhospcode == 41173)
      <div class="col-lg-12">
        ...
        <div class="col-lg-3">
          <a href="{{ route('lstf1n') }}" class="btn btn-block btn-danger">ดูข้อมูลวันที่ {{$datenow}}</a>
          </div>
        <div class="col-lg-3">
            ...
            <td>
              <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu">
                  ...
                  <li><a href="{{ route('EditAEFI1n') }}?id_case={{ $value->id_case }}" target="_blank"><i class="fa fa-pencil-square-o" aria-hidden="true" style="color:#5bc0de;"></i>แก้ไขข้อมูล</a></li>
