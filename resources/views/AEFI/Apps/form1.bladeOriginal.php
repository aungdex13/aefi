                        ...
                        <div class="form-group">
                          <div class="col-lg-6">
                            ...
                            <div class="input-group date">
                              ...
                              <input type="text" class="form-control  readonly pull-right" id="datepicker_stdiag" name="date_of_symptoms" data-date-format="yyyy-mm-dd" autocomplete="off" required>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="form-group">
                            <div class="col-lg-6">
                              ...
                              <div class="input-group">
                                <input type="time" class="form-control" name="time_of_symptoms" required>
                              </div>
                            </div>
                          </div>
                        </div>
