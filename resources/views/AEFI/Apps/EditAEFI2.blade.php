...
<section class="content">
	<form role="form" action="{{ route('updateform2') }}" method="post" enctype="multipart/form-data">
		{{ csrf_field() }}
		<div class="row">
			<div class="col-md-12">
				<!-- Custom Tabs -->
										...
										<div class="box box-danger">
													...
													<div class="row">
														...
														<div class="col-lg-3">
															<div id="other_prior_to_immunization_1">
																<input name="other_prior_to_immunization_1" id="other_prior_to_immunization_1_text" value="{{ $data[0]->other_prior_to_immunization_1 }}" type="text" class="form-control" placeholder="ระบุ">
															</div>
														</div>
													</div>
												</div>
													...
													<div class="row">
														...
														<div class="col-lg-3">
															<div id="other_prior_to_immunization_2">
																<input name="other_prior_to_immunization_2" id="other_prior_to_immunization_2_text" value="{{ $data[0]->other_prior_to_immunization_2 }}" type="text" class="form-control" placeholder="ระบุ">
															</div>
														</div>
													</div>
												</div>
													...
													<div class="row">
														...
														<div class="col-lg-3">
															<div id="other_prior_to_immunization_3">
																<input name="other_prior_to_immunization_3" id="other_prior_to_immunization_3_text" value="{{ $data[0]->other_prior_to_immunization_3 }}" type="text" class="form-control" placeholder="ระบุ">
															</div>
														</div>
													</div>
												</div>
													...
													<div class="row">
														...
														<div class="col-lg-3">
															<div id="other_prior_to_immunization_4">
																<input name="other_prior_to_immunization_4" id="other_prior_to_immunization_4_text" value="{{ $data[0]->other_prior_to_immunization_4 }}" type="text" class="form-control" placeholder="ระบุ">
															</div>
														</div>
													</div>
												</div>
													...
													<div class="row">
														...
														<div class="col-lg-3">
															<div id="other_prior_to_immunization_5">
																<input name="other_prior_to_immunization_5" id="other_prior_to_immunization_5_text" value="{{ $data[0]->other_prior_to_immunization_5 }}" type="text" class="form-control" placeholder="ระบุ">
															</div>
														</div>
													</div>
												</div>
													...
													<div class="row">
														...
														<div class="col-lg-3">
															<div id="other_prior_to_immunization_6">
																<input type="text" name="other_prior_to_immunization_6" id="other_prior_to_immunization_6_text" value="{{ $data[0]->other_prior_to_immunization_6 }}" class="form-control" placeholder="ระบุ" hidden="true">
															</div>
														</div>
													</div>
												</div>
													...
													<div class="row">
														...
														<div class="col-lg-3">
															<div id="other_prior_to_immunization_7">
																<input type="text" name="other_prior_to_immunization_7" id="other_prior_to_immunization_7_text" value="{{ $data[0]->other_prior_to_immunization_7 }}" class="form-control" placeholder="ระบุ" hidden="true">
															</div>
														</div>
													</div>
												</div>
													...
													<div class="row">
														...
														<div class="col-lg-3">
															<div id="other_prior_to_immunization_8">
																<input type="text" name="other_prior_to_immunization_8" id="other_prior_to_immunization_8_text" value="{{ $data[0]->other_prior_to_immunization_8 }}" class="form-control" placeholder="ระบุ" hidden="true">
															</div>
														</div>
													</div>
												</div>
																...
																<div class="row">
																	...
																	<div class="col-lg-3">
																		<div id="other_for_adult_woman_1">
																			<input type="text" name="other_for_adult_woman_1" id="other_for_adult_woman_1_text" class="form-control" value="{{ $data[0]->other_for_adult_woman_1 }}" placeholder="ระบุ(จำนวนสัปดาห์)" hidden="true">
																		</div>
																	</div>
																</div>
															</div>
											...
											<div class="box-footer">
												<form role="form">
													<div class="form-group">
														<div class="col-lg-12">
															<label>สำหรับทารก (อายุ < 1 ปี) การคลอด</label> </div> </div> <div class="form-group">
																	<div class="col-lg-12">
																		<!-- โรคประจำตัว/การเจ็บป่วยในอดีต -->
																		<div class="form-group">
																			<div class="row">
																				...
																				<div class="col-lg-3">
																					<div id="other_for_infants_less_than_1_year_1">
																						<input type="text" name="other_for_infants_less_than_1_year_1" id="other_for_infants_less_than_1_year_1_text" value="{{ $data[0]->other_for_infants_less_than_1_year_1 }}" class="form-control"
																							placeholder="น้ำหนักแรกคลอด(กรัม)" hidden="true">
																					</div>
																				</div>
																			</div>
																		</div>
																			...
																			<div class="row">
																				...
																				<div class="col-lg-4">
																					<div id="other_for_infants_less_than_1_year_2">
																						<input type="text" name="other_for_infants_less_than_1_year_2" id="other_for_infants_less_than_1_year_2_text" value="{{ $data[0]->other_for_infants_less_than_1_year_2 }}" class="form-control"
																							placeholder="ระบุ" hidden="true">
																					</div>
																				</div>
																			</div>
																		</div>
																	...
																	<div class="col-md-12">
																			...
																			<div class="row">
																				...
																				<div class="col-lg-3">
																					<div id="other_source" style="display: none">
																						<input type="text" name="other_source" id="other_source_text" value="{{ $data[0]->other_source }}" class="form-control" placeholder="ระบุ" hidden="true">
																					</div>
																				</div>
																			</div>
																		</div>
																		<div class="form-group">
																			<div class="row">
																				...
																				<div class="col-lg-3">
																					<input type="text" name="source_1_2" value="{{ $data[0]->source_1_2 }}" class="form-control" placeholder="ระบุ">
																				</div>
																			</div>
																		</div>
																	</div>
																	...
																	<div class="col-md-12">
																		...
																		<div class="form-group">
																			<div class="row">
																				...
																				<div class="col-lg-12">
																					<textarea class="form-control" name="symptoms_2" rows="3" placeholder="Enter ...">{{ $data[0]->symptoms_2 }}</textarea>
																				</div>
																			</div>
																		</div>
																		<div class="form-group">
																			<div class="row">
																				...
																				<div class="col-lg-3">
																					<input type="text" name="symptoms_2_1" value="{{ $data[0]->symptoms_2_1 }}" class="form-control" placeholder="ระบุ">
																				</div>
																			</div>
																		</div>
																	</div>
																				...
																				<div class="col-lg-4">
																					<div class="control-label">
																						...
																						<div class="input-group date">
																							...
																							<input type="text" name="symptoms_2_2" id="datepicker_symptoms" value="{{ $data[0]->symptoms_2_2 }}" class="form-control" placeholder="ระบุ">
																						</div>
																					</div>
																				</div>
																				<div class="col-lg-4">
																					...
																					<div class="bootstrap-timepicker">
																						<div class="form-group">
																							...
																							<div class="input-group">
																								<input type="text" name="symptoms_2_3" value="{{ $data[0]->symptoms_2_3 }}" class="form-control timepicker_Symptoms">
																				...
																				<div class="col-lg-4">
																					<div class="control-label">
																						...
																						<div class="input-group date">
																							...
																							<input type="text" id="datepicker_date_treat" name="symptoms_2_4" value="{{ $data[0]->symptoms_2_4 }}" class="form-control" placeholder="ระบุ">
																						</div>
																					</div>
																				</div>
																			</div>
																				...
																				<div class="col-lg-4">
																					<div class="control-label">
																						...
																						<div class="input-group date">
																							...
																							<input type="text" id="datepicker_Symptoms_2_5" name="symptoms_2_5" value="{{ $data[0]->symptoms_2_5 }}" class="form-control" placeholder="ระบุ">
																						</div>
																					</div>
																				</div>
																				<div class="col-lg-4">
																					<div class="control-label">
																						...
																						<input type="text" name="treatment_place" value="{{ $data[0]->treatment_place }}" class="form-control" placeholder="ระบุ">
																					</div>
																				</div>
																				<div class="col-lg-4">
																					<div class="control-label">
																						<label>แพทย์ผู้รักษา :</label>
																						<input type="text" name="doctor_name" value="{{ $data[0]->doctor_name }}" class="form-control" placeholder="ระบุ">
																					</div>
																				</div>
																			</div>
																		</div>
																			...
																			<div class="row">
																				...
																				<div class="col-lg-3">
																					<div id="other_status_on_date_inv_1" style="display: none">
																						<input type="text" name="other_status_on_date_inv_1" id="other_status_on_date_inv_1_text" value="{{ $data[0]->other_status_on_date_inv_1 }}" class="form-control" placeholder="ระบุ" hidden="true">
																					</div>
																				</div>
																			</div>
																		</div>
																			...
																			<div class="row">
																				...
																				<div class="col-lg-6">
																					<div id="other_status_on_date_inv_1_2" style="display: none">
																						<input type="text" name="other_status_on_date_inv_1_21" id="other_status_on_date_inv_1_3_text" value="{{ $data[0]->other_status_on_date_inv_1_21 }}" class="form-control" placeholder="ระบุ" hidden="true">
																						<input type="text" name="other_status_on_date_inv_1_22" id="other_status_on_date_inv_1_4_text" value="{{ $data[0]->other_status_on_date_inv_1_22 }}" class="form-control" placeholder="ระบุ" hidden="true">
																						<input type="text" name="other_status_on_date_inv_1_23" id="other_status_on_date_inv_1_5_text" value="{{ $data[0]->other_status_on_date_inv_1_23 }}" class="form-control" placeholder="ระบุ" hidden="true">
																					</div>
																				</div>
																			</div>
																		</div>
																	...
																	<div class="col-md-12">
																		...
																		<div class="form-group">
																			<div class="row">
																				<div class="col-lg-6">
																					...
																					<input type="text" name="record1" value="{{ $data[0]->record1 }}" class="form-control" placeholder="ระบุ">
																				</div>
																			</div>
																		</div>
																		<!-- general form elements -->
																		<div class="form-group">
																			<div class="row">
																				<div class="col-lg-3">
																					<label>ตำแหน่ง : </label>
																					<input type="text" name="record2" value="{{ $data[0]->record2 }}" class="form-control" placeholder="ระบุตำแหน่ง">
																				</div>
																				<div class="col-lg-3">
																					<label>หน่วยงาน : </label>
																					<input type="text" name="record3" value="{{ $data[0]->record3 }}" class="form-control" placeholder="ระบุหน่วยงาน">
																				</div>
																				<div class="col-lg-3">
																					<label>โทร : </label>
																					<input type="text" name"record4" value="{{ $data[0]->record4 }}" class="form-control" placeholder="ระบหมายเลขติดต่อ">
																				</div>
																				<div class="col-lg-3">
																					...
																					<div class="input-group date">
																						...
																						<input type="text" id="datepicker_record5" name="record5" value="{{ $data[0]->record5 }}" class="form-control" placeholder="ระบวันที่บันทึกข้อมูล">
																					</div>
																				</div>
																			</div>
																		</div>
																...
																<div class="box-body">
																	...
																	<div class="col-md-12">
																		...
																		<table class="table table-striped" id="maintable">
																			...
																			@php
																			//$datavac->toArray();
																			for ($i=0; $i<=4; $i++) { if (isset($datavac[$i]->name_vac))
																				$name_vac = $datavac[$i]->name_vac;
																				else
																				$name_vac = null;
																				echo "<tr class=\"data-contact-person\">\n";
																					echo "<td><input type=\"text\" id=\"name_vac".$i."\" name=\"name_vac[]\" value=\"".$name_vac."\" class=\"form-control\"></td>";

																					if (isset($datavac[$i]->recive_amount))
																					$recive_amount = $datavac[$i]->recive_amount;
																					else
																					$recive_amount = null;
																					echo "<td><input type=\"text\" id=\"recive_amount".$i."\" name=\"recive_amount[]\" value=\"".$recive_amount."\" class=\"form-control\"></td>";
																					echo "</tr>";
																				}
																				@endphp
																		</table>
																	...
																	<div class="col-md-12">
																			...
																			<div class="row">
																				...
																				<div class="col-lg-3">
																					<div id="other_patient_immunized_2">
																						<input type="text" id="other_patient_immunized_2_text" name="other_patient_immunized_2" value="{{ $data[0]->other_patient_immunized_2 }}" class="form-control" placeholder="ระบุ" hidden="true">
																					</div>
																				</div>
																			</div>
																		</div>
																			...
																			<div class="row">
																				...
																				<div class="col-lg-3">
																					<div id="other_patient_immunized_3">
																						<input type="text" id="other_patient_immunized_3_text" name="other_patient_immunized_3" value="{{ $data[0]->other_patient_immunized_3 }}" class="form-control" placeholder="ระบุ" hidden="true">
																					</div>
																				</div>
																			</div>
																		</div>
																			...
																			<div class="row">
																				...
																				<div class="col-lg-3">
																					<div id="other_patient_immunized_4">
																						<input type="text" id="other_patient_immunized_4_text" name="other_patient_immunized_4" value="{{ $data[0]->other_patient_immunized_4 }}" class="form-control" placeholder="ระบุ" hidden="true">
																					</div>
																				</div>
																			</div>
																		</div>
																			...
																			<div class="row">
																				...
																				<div class="col-lg-3">
																					<div id="other_patient_immunized_5">
																						<input type="text" id="other_patient_immunized_5_text" name="other_patient_immunized_4" value="{{ $data[0]->other_patient_immunized_4 }}" class="form-control" placeholder="ระบุ" hidden="true">
																					</div>
																				</div>
																			</div>
																		</div>
																			...
																			<div class="row">
																				...
																				<div class="col-lg-3">
																					<div id="other_patient_immunized_6">
																						<input type="text" id="other_patient_immunized_6_text" name="other_patient_immunized_6" value="{{ $data[0]->other_patient_immunized_6 }}" class="form-control" placeholder="ระบุ" hidden="true">
																					</div>
																				</div>
																			</div>
																		</div>
																			...
																			<div class="row">
																				...
																				<div class="col-lg-3">
																					<div id="other_patient_immunized_7">
																						<input type="text" id="other_other_patient_immunized_7_text" name="other_patient_immunized_7" value="{{ $data[0]->other_patient_immunized_7 }}" class="form-control" placeholder="ระบุ" hidden="true">
																					</div>
																				</div>
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			<div class="row">
																				...
																				<div class="col-lg-3">
																					<input type="text" name="patient_immunized_8" value="{{ $data[0]->patient_immunized_8 }}" class="form-control" placeholder="ระบุจำนวนผู้ได้รับวัคซีนขวดเดียวกันกับผู้ป่วย">
																				</div>
																				<div class="col-lg-3">
																					<input type="text" name="patient_immunized_8_1" value="{{ $data[0]->patient_immunized_8_1 }}" class="form-control" placeholder="ระบุจำนวนผู้มีอาการป่วย">
																				</div>
																			</div>
																		</div>
																		<!-- general form elements -->
																		<div class="form-group">
																			<div class="row">
																				...
																				<div class="col-lg-3">
																					<input type="text" name="patient_immunized_9" value="{{ $data[0]->patient_immunized_9 }}" class="form-control" placeholder="จำนวนผู้ได้รับวัคซีนวันเดียวกันกับผู้ป่วย">
																				</div>
																				<div class="col-lg-3">
																					<input type="text" name="patient_immunized_9_1" value="{{ $data[0]->patient_immunized_9_1 }}" class="form-control" placeholder="ระบุจำนวนผู้มีอาการป่วย">
																				</div>
																			</div>
																		</div>
																		<!-- general form elements -->
																		<div class="form-group">
																			<div class="row">
																				...
																				<div class="col-lg-5">
																					<input type="text" name="patient_immunized_10" value="{{ $data[0]->patient_immunized_10 }}" class="form-control" placeholder="จำนวนผู้ได้รับวัคซีน lot no.เดียวกันในสถานบริการแห่งอื่นๆในเขตอำเภอเดียวกัน">
																				</div>
																				<div class="col-lg-3">
																					<input type="text" name="patient_immunized_10_1" value="{{ $data[0]->patient_immunized_10_1 }}" class="form-control" placeholder="ระบุจำนวนสถานบริการ">
																				</div>
																				<div class="col-lg-3">
																					<input type="text" name="patient_immunized_10_2" value="{{ $data[0]->patient_immunized_10_2 }}" class="form-control" placeholder="ระบุจำนวนผู้มีอาการป่วย">
																				</div>
																			</div>
																		</div>
																		<!-- general form elements -->
																			...
																			<div class="row">
																				...
																				<div class="col-lg-3">
																					<div id="other_patient_immunized_11">
																						<input type="text" id="other_patient_immunized_11_text" name="other_patient_immunized_11" value="{{ $data[0]->other_patient_immunized_11 }}" class="form-control" placeholder="มีจำนวนผู้ป่วยทั้งหมด...คน"
																							hidden="true">
																					</div>
																				</div>
																			</div>
																			<div class="row">
																				...
																				<div class="col-lg-3">
																					<div id="other_patient_immunized_12">
																						<input type="text" id="other_patient_immunized_12_text" name="other_patient_immunized_12" value="{{ $data[0]->other_patient_immunized_12 }}" class="form-control"
																							placeholder="มีจำนวนขวดวัคซีน่ผู้ป่วยได้รับ...ขวด" hidden="true">
																					</div>
																				</div>
																			</div>
																		</div>
																			...
																			<div class="row">
																				...
																				<div class="col-lg-3">
																					<div id="other_immunization_practices_1_1" style="display: none">
																						<input type="text" id="immunization_practices_1_1_text" name="other_immunization_practices_1_1" value="{{ $data[0]->other_immunization_practices_1_1 }}" class="form-control" placeholder="ระบุ"
																							hidden="true">
																					</div>
																				</div>
																			</div>
																	...
																	<div class="col-md-12">
																		...
																		<div class="form-group">
																			<div class="row">
																				...
																				<div class="col-lg-12">
																					<textarea name="immunization_practices_1_4" class="form-control" rows="3" placeholder="Enter ...">{{ $data[0]->immunization_practices_1_4 }}</textarea>
																				</div>
																			</div>
																		</div>
																	</div>
																	...
																	<div class="col-md-12">
																		...
																		<div class="form-group">
																			<div class="row">
																				...
																				<div class="col-lg-12">
																					<textarea name="reconstitution_5" class="form-control" rows="3" placeholder="Enter ...">{{ $data[0]->reconstitution_5 }}</textarea>
																				</div>
																			</div>
																		</div>
																	</div>
																	...
																	<div class="col-md-12">
																			...
																			<div class="row">
																				...
																				<div class="col-lg-3">
																					<div id="vaccine_storage_1_1" style="display: none">
																						<input type="text" id="other_vaccine_storage_1_1_text" name="vaccine_storage_1_1" value="{{ $data[0]->vaccine_storage_1_1 }}" class="form-control" placeholder="ระบุ" hidden="true">
																					</div>
																				</div>
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			<div class="row">
																				...
																				<div class="col-lg-6">
																					<div class="radio">
																						<textarea name="vaccine_storage_1_3" class="form-control" rows="3" placeholder="Enter ...">{{ $data[0]->vaccine_storage_1_3 }}</textarea>
																					</div>
																				</div>
																			</div>
																		</div>
																	...
																	<div class="col-md-12">
																		...
																		<div class="col-lg-12">
																			<div class="control-label">
																				...
																				<textarea name="vaccine_storage_7" class="form-control" rows="3" placeholder="Enter ...">{{ $data[0]->vaccine_storage_7 }}</textarea>
																			</div>
																		</div>
																	</div>
																</div>
																	...
																	<div class="col-md-12">
																		...
																		<div class="form-group">
																			<div class="row">
																				...
																				<div class="col-lg-6">
																					<div class="radio">
																						<textarea name="vaccine_transportation_1_1" class="form-control" rows="3" placeholder="Enter ...">{{ $data[0]->vaccine_transportation_1_1 }}</textarea>
																					</div>
																				</div>
																			</div>
																		</div>
																...
																<div class="box-footer">
																	...
																	<div class="col-md-12">
																		...
																		<div class="col-lg-12">
																			<div class="control-label">
																				<label>รายละเอียดเพิ่มเติม :</label>
																				<textarea name="vaccine_transportation_4" class="form-control" rows="3" placeholder="Enter ...">{{ $data[0]->vaccine_transportation_4 }}</textarea>
																			</div>
																		</div>
																	</div>
																</div>
																				...
																				<div class="col-lg-12">
																					<div class="col-lg-4">
																						<div id="other_community_inv_1">
																							<input id="other_community_inv_1_text" name="community_inv_1_1" value="{{ $data[0]->community_inv_1_1 }}" type="text" class="form-control" placeholder="ถ้ามี มีกี่ราย" hidden="true">
																							<input id="other_community_inv_1_text" name="community_inv_1_2" value="{{ $data[0]->community_inv_1_2 }}" type="text" class="form-control" placeholder="เป็นผู้ได้รับวัคซีนกี่ราย" hidden="true">
																							<input id="other_community_inv_1_text" name="community_inv_1_3" value="{{ $data[0]->community_inv_1_3 }}" type="text" class="form-control" placeholder="ไม่ได้รับวัคซีนกี่ราย" hidden="true">
																							<input id="other_community_inv_1_text" name="community_inv_1_4" value="{{ $data[0]->community_inv_1_4 }}" type="text" class="form-control" placeholder="ไม่ทราบ" hidden="true">
																							<input id="other_community_inv_1_text" name="community_inv_1_5" value="{{ $data[0]->community_inv_1_5 }}" type="text" class="form-control" placeholder="อธิบายรายละเอียด" hidden="true">
																						</div>
																					</div>
																				</div>
																			</div>
																			...
																			<div class="row">
																				...
																				<div class="col-lg-6">
																					<div id="other_no_ad_syringes" style="display: none">
																						<input name="other_no_ad_syringes" id="other_no_ad_syringes_text" value="{{ $data[0]->other_no_ad_syringes }}" type="text" class="form-control" placeholder="ระบุ" hidden="true">
																					</div>
																				</div>
																			</div>
																		</div>
															...
															<div class="box-header with-border">
																		...
																		<div class="form-group">
																			<div class="row">
																				<div class="col-lg-3">
																					...
																					<textarea name="events" class="form-control" rows="3" placeholder="Enter ...">{{ $data[0]->events }}</textarea>
																				</div>
																			</div>
																		</div>
																	</div>
																...
																<div class="box-footer">
																	...
																	<div class="col-md-12">
																		...
																		<div class="form-group">
																			<div class="row">
																				{{-- <input name="investigater_1[]" value="{{ $datainv[0]->investigater_1 }}" type="text" class="form-control" placeholder="ระบุตำแหน่ง"> --}}
																				@php
																				for ($i=0; $i<=4; $i++) { if (isset($datainv[$i]->investigater_1))
																					$investigater_1 = $datainv[$i]->investigater_1;
																					else
																					$investigater_1 = null;
																					echo "<div class=\"col-lg-3\">";
																						echo "<label>ชื่อ-สกุลผู้สอบสวน : </label>";
																						echo "<input type=\"text\" id=\"investigater_1".$i."\" name=\"investigater_1[]\" value=\"".$investigater_1."\" class=\"form-control\">";
																						echo "</div>";

																					if (isset($datainv[$i]->investigater_1_2))
																					$investigater_1_2 = $datainv[$i]->investigater_1_2;
																					else
																					$investigater_1_2 = null;
																					echo "<div class=\"col-lg-3\">";
																						echo "<label>ตำแหน่ง : </label>";
																						echo "<input type=\"text\" id=\"investigater_1_2".$i."\" name=\"investigater_1_2[]\" value=\"".$investigater_1_2."\" class=\"form-control\">";
																						echo "</div>";

																					if (isset($datainv[$i]->investigater_1_3))
																					$investigater_1_3 = $datainv[$i]->investigater_1_3;
																					else
																					$investigater_1_3 = null;
																					echo "<div class=\"col-lg-3\">";
																						echo "<label>หน่วยงาน : </label>";
																						echo "<input type=\"text\" id=\"investigater_1_3".$i."\" name=\"investigater_1_3[]\" value=\"".$investigater_1_3."\" class=\"form-control\">";
																						echo "</div>";

																					if (isset($datainv[$i]->investigater_1_4))
																					$investigater_1_4 = $datainv[$i]->investigater_1_4;
																					else
																					$investigater_1_4 = null;
																					echo "<div class=\"col-lg-3\">";
																						echo "<label>โทร : </label>";
																						echo "<input type=\"text\" id=\"investigater_1_4".$i."\" name=\"investigater_1_4[]\" value=\"".$investigater_1_4."\" class=\"form-control\">";
																						echo "</div>";
																					}
																					@endphp
																			</div>
																			...
																			<div class="row">
																				<div class="col-lg-3">
																					...
																					<div class="input-group date">
																						...
																						<input id="datepicker_investigater_2" name="investigater_2" value="{{ $data[0]->investigater_2 }}" type="text" class="form-control" placeholder="ระบุตำแหน่ง">
																					</div>
																				</div>
																				<div class="col-lg-3">
																					...
																					<div class="input-group date">
																						...
																						<input id="datepicker_investigater_3" name="investigater_3" value="{{ $data[0]->investigater_3 }}" type="text" class="form-control" placeholder="ระบุตำแหน่ง">
																					</div>
																				</div>
																				<div class="col-lg-3">
																					...
																					<div class="input-group date">
																						...
																						<input id="datepicker_investigater_4" name="investigater_4" value="{{ $data[0]->investigater_4 }}" type="text" class="form-control" placeholder="ระบุตำแหน่ง">
																					</div>
																				</div>
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			<div class="row">
																				<div class="col-lg-3">
																					...
																					<input name="investigater_5" value="{{ $data[0]->investigater_5 }}" type="text" class="form-control" placeholder="ระบุตำแหน่ง">
																				</div>
																				<div class="col-lg-3">
																					<label>ตำแหน่ง: </label>
																					<input name="investigater_5_2" value="{{ $data[0]->investigater_5_2 }}" type="text" class="form-control" placeholder="ระบุตำแหน่ง">
																				</div>
																				<div class="col-lg-3">
																					<label>หน่วยงาน : </label>
																					<input name="investigater_5_3" value="{{ $data[0]->investigater_5_3 }}" type="text" class="form-control" placeholder="ระบุตำแหน่ง">
																				</div>
																			</div>
																		</div>
																	</div>
																		...
																		<div class="form-group">
																			<div class="row">
																				<div class="col-lg-3">
																					...
																					<input name="investigater_8" value="{{ $data[0]->investigater_8 }}" type="text" class="form-control" placeholder="ระบุตำแหน่ง">
																				</div>
																				<div class="col-lg-3">
																					<label>มือถือ : </label>
																					<input name="investigater_9" value="{{ $data[0]->investigater_9 }}" type="text" class="form-control" placeholder="ระบุตำแหน่ง">
																				</div>
																				<div class="col-lg-3">
																					<label>E mail : </label>
																					<input name="investigater_10" value="{{ $data[0]->investigater_10 }}" type="text" class="form-control" placeholder="ระบุตำแหน่ง">
																				</div>
																			</div>
																		</div>
																	</div>
