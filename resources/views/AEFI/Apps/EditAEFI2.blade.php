		  								...
		  								<div class="form-group">
		  									<div class="row">
		  										...
		  										<div class="col-lg-3">
		  											...
		  											<input type="text" name="other_for_infants_less_than_1_year_1" id="other_for_infants_less_than_1_year_1_text"  value="{{ $data[0]->other_for_infants_less_than_1_year_1 }}" class="form-control" placeholder="น้ำหนักแรกคลอด(กรัม)" hidden="true">
		  											</div>
		  										</div>
		  									</div>
		  								</div>
		  								...
		  								<div class="form-group">
		  									<div class="row">
		  										...
		  										<div class="col-lg-4">
		  											...
		  											<input type="text" name="other_for_infants_less_than_1_year_2" id="other_for_infants_less_than_1_year_2_text"  value="{{ $data[0]->other_for_infants_less_than_1_year_2 }}" class="form-control" placeholder="ระบุ" hidden="true">
		  											</div>
		  										</div>
		  									</div>
		  								</div>
										...
										<div class="form-group">
											<div class="row">
												...
												<div class="col-lg-3">
													...
													<input type="text"  id="other_patient_immunized_11_text" name="other_patient_immunized_11" value="{{ $data[0]->other_patient_immunized_11 }}" class="form-control" placeholder="มีจำนวนผู้ป่วยทั้งหมด...คน" hidden="true">
													</div>
												</div>
											</div>
											<div class="row">
												...
												<div class="col-lg-3">
													...
													<input type="text"  id="other_patient_immunized_12_text" name="other_patient_immunized_12" value="{{ $data[0]->other_patient_immunized_12 }}" class="form-control" placeholder="มีจำนวนขวดวัคซีน่ผู้ป่วยได้รับ...ขวด" hidden="true">
													</div>
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												<div class="row">
													...
													<div class="col-lg-3">
														...
														<input type="text" id="immunization_practices_1_1_text" name="other_immunization_practices_1_1" value="{{ $data[0]->other_immunization_practices_1_1 }}" class="form-control" placeholder="ระบุ" hidden="true">
														</div>
													</div>
												</div>
											</div>
									...
									<div class="box-footer">
										...
										<div class="form-group">
											<div class="row">
													...
													@php
													for ($i=0; $i<=4; $i++) {
														if (isset($datainv[$i]->investigater_1))
