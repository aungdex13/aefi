...
<section class="content">
	<div class="row">
			...
			<div class="box box-info">
				...
				<h3 class="box-title"><a href="{{ route('form1') }}" type="button" class="btn btn-success btn-flat"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>เพิ่มผู้ป่วย AEFI</a></h3>
				</div>
				<!-- /.box-header -->
				<!-- form start -->
		            <!-- /.box-header -->
