																	...
																	<div class="col-md-12">
																		...
																		<div class="form-group">
																			<div class="row">
																				...
																				<input type="text" name="id_case" value="{{$selectexpertcase[0]->id_case}}" hidden>
																		...
																		<div class="form-group">
																			<div class="row">
																				<div class="col-lg-3">
																					<label>ST No. : </label>
																					<input type="text" name="stno" class="form-control" value="{{isset($selectexpertcase[0]->stno) ? $selectexpertcase[0]->stno : null}}" placeholder="ระบุ ST No.">
																				</div>
																				<div class="col-lg-3">
																					<label>Skin : </label>
																						<input type="text" name="skin" class="form-control" value="{{isset($selectexpertcase[0]->skin) ? $selectexpertcase[0]->skin : null}}" placeholder="ระบุ Skin">
																				</div>
																				<div class="col-lg-3">
																					<label>GI : </label>
																			...
																			<div class="row">
																				<div class="col-lg-6">
																						...
																						<select type="text" class="form-control" name="r_o">
																							<option value="{{isset($selectexpertcase[0]->r_o) ? $selectexpertcase[0]->r_o : null}}">{{isset($arr_r_o[$selectexpertcase[0]->r_o]) ? $arr_r_o[$selectexpertcase[0]->r_o] : null}}</option>
																				...
																				<div class="col-lg-6">
																					...
																					<textarea type="text" name="other_r_o" class="form-control" rows="3" placeholder="กรอกข้อมูล R/O อื่นๆ">{{isset($selectexpertcase[0]->other_r_o) ? $selectexpertcase[0]->other_r_o : null}}</textarea>
																				</div>
																			</div>
																		</div>
																		<div class="form-group">
																			<div class="row">
																				<div class="col-lg-3">
																					...
																					<input type="text" name="respiratory" class="form-control" value="{{isset($selectexpertcase[0]->respiratory) ? $selectexpertcase[0]->respiratory : null}}" placeholder="ระบุ Respiratory">
																				</div>
																				<div class="col-lg-3">
																					<label>Neurological : </label>
																					<input type="text" name="neurological" class="form-control" value="{{isset($selectexpertcase[0]->neurological) ? $selectexpertcase[0]->neurological : null}}" placeholder="ระบุ Neurological">
																				</div>
																				<div class="col-lg-3">
																			...
																			<div class="row">
																				<div class="col-lg-6">
																					...
																					<select type="text" name="final_diag" class="form-control">
																						<option value="{{isset($selectexpertcase[0]->final_diag) ? $selectexpertcase[0]->final_diag : null}}">{{isset($arr_load_final_diag[$selectexpertcase[0]->final_diag]) ? $arr_load_final_diag[$selectexpertcase[0]->final_diag] : null}}</option>
																				...
																				<div class="col-lg-6">
																					...
																					<textarea type="text" name="other_final_diag" class="form-control" rows="3" placeholder="กรอกข้อมูล Final Diagnosis อื่นๆ">{{isset($selectexpertcase[0]->other_final_diag) ? $selectexpertcase[0]->other_final_diag : null}}</textarea>
																				</div>
																			</div>
																		</div>
																		<div class="form-group">
																			<div class="row">
																				<div class="col-lg-6">
																					...
																					<select type="text" name="causality" class="form-control">
																						<option value="{{isset($selectexpertcase[0]->causality) ? $selectexpertcase[0]->causality : null}}">{{isset($arr_causality[$selectexpertcase[0]->causality]) ? $arr_causality[$selectexpertcase[0]->causality] : null}}</option>
																				...
																				<div class="col-lg-6">
																					<label>Summary : </label>
																					<textarea type="text" name="summary" class="form-control" rows="3" placeholder="กรอกข้อมูล Summary">{{isset($selectexpertcase[0]->summary) ? $selectexpertcase[0]->summary : null}}</textarea>
																				</div>
																			</div>
																		</div>
																		<div class="form-group">
																			<div class="row">
																				<div class="col-lg-3">
																					...
																					<div class="input-group date">
																						...
																						<input type="text" name="expert_meet_date" class="form-control pull-right" id="datepicker_investigater_2"  value="{{isset($selectexpertcase[0]->expert_meet_date) ? $selectexpertcase[0]->expert_meet_date : null}}" data-date-format="yyyy-mm-dd" required readonly>
																		...
																		<div class="form-group">
																			<div class="row">
																				<div class="col-lg-3">
																					...
																					<input type="text" name="keyin_aefiddc" class="form-control" value="{{isset($selectexpertcase[0]->keyin_aefiddc) ? $selectexpertcase[0]->keyin_aefiddc : null}}" placeholder="ระบุ keyin_AEFIDDC">
																				</div>
																				<div class="col-lg-3">
																					<label>Print Data : </label>
																						<input type="text" name="printdata" class="form-control" value="{{isset($selectexpertcase[0]->printdata) ? $selectexpertcase[0]->printdata : null}}" placeholder="ระบุ Print Data">
																				</div>
																				<div class="col-lg-3">
