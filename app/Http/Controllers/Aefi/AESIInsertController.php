...
class AESIInsertController extends Controller
{
    public function insertaesiform1(Request $req)
 {
				...
				$Serum_COVID_19_IgM = $req ->input('Serum_COVID_19_IgM');
				$Serum_COVID_19_IgM1_date = $req ->input('Serum_COVID_19_IgM1_date');
				$Serum_COVID_19_IgM1_PCR = $req ->input('Serum_COVID_19_IgM1_PCR');
				$Serum_COVID_19_IgM2_lab = $req ->input('Serum_COVID_19_IgM2_lab');
				$Serum_COVID_19_IgM2_date = $req ->input('Serum_COVID_19_IgM2_date');
				$Serum_COVID_19_IgM2_PCR = $req ->input('Serum_COVID_19_IgM2_PCR');
				$Serum_COVID_19_IgM2_lab1 = $req ->input('Serum_COVID_19_IgM2_lab1');
				$Serum_COVID_19_IgG = $req ->input('Serum_COVID_19_IgG');
				$Serum_COVID_19_IgG1_date = $req ->input('Serum_COVID_19_IgG1_date');
				$Serum_COVID_19_IgG1_PCR = $req ->input('Serum_COVID_19_IgG1_PCR');
				$Serum_COVID_19_IgG2_lab = $req ->input('Serum_COVID_19_IgG2_lab');
				$Serum_COVID_19_IgG2_date = $req ->input('Serum_COVID_19_IgG2_date');
				$Serum_COVID_19_IgG2_PCR = $req ->input('Serum_COVID_19_IgG2_PCR');
				$Serum_COVID_19_IgG2_lab1 = $req ->input('Serum_COVID_19_IgG2_lab1');
				...
				$username_reporter = auth()->user()->username;
				$province_reporter = auth()->user()->prov_code;
...
$data = array(
					...
					"NPS_PCR"=>$NPS_PCR,
					"NPS_lab"=>$NPS_lab,
					"Serum_COVID_19_IgM"=>$Serum_COVID_19_IgM,
					"Serum_COVID_19_IgM1_date"=>$Serum_COVID_19_IgM1_date,
					"Serum_COVID_19_IgM1_PCR"=>$Serum_COVID_19_IgM1_PCR,
					"Serum_COVID_19_IgM2_lab"=>$Serum_COVID_19_IgM2_lab,
					"Serum_COVID_19_IgM2_date"=>$Serum_COVID_19_IgM2_date,
					"Serum_COVID_19_IgM2_PCR"=>$Serum_COVID_19_IgM2_PCR,
					"Serum_COVID_19_IgM2_lab1"=>$Serum_COVID_19_IgM2_lab1,
					"Serum_COVID_19_IgG"=>$Serum_COVID_19_IgG,
					"Serum_COVID_19_IgG1_date"=>$Serum_COVID_19_IgG1_date,
					"Serum_COVID_19_IgG1_PCR"=>$Serum_COVID_19_IgG1_PCR,
					"Serum_COVID_19_IgG2_lab"=>$Serum_COVID_19_IgG2_lab,
					"Serum_COVID_19_IgG2_date"=>$Serum_COVID_19_IgG2_date,
					"Serum_COVID_19_IgG2_PCR"=>$Serum_COVID_19_IgG2_PCR,
					"Serum_COVID_19_IgG2_lab1"=>$Serum_COVID_19_IgG2_lab1,
...
if ($res2) {
$msg = " ส่งข้อมูลสำเร็จ";
$url_rediect = "<script>alert('".$msg."'); window.location='lstaesif1';</script> ";
}else{
...
public function updateaesiform1(Request $req) {
	$id = $req->input('id');
	$id_case = $req->input('id_case');
	$hn = $req->input('hn');
	...
	->update([ 
		...
		'career_code' => $req->career_code,
		'congenital_disease' => $req->congenital_disease,
		'regular_medication' => $req->regular_medication,
		'house_number' => $req->house_number,
		'village_no' => $req->village_no,
		'province' => $req->province,
		'district' => $req->district,
		'subdistrict' => $req->subdistrict,
		'phone_number' => $req->phone_number,
		'parent_title_name' => $req->parent_title_name,
		'parent_first_name' => $req->parent_first_name,
		'parent_last_name' => $req->parent_last_name,
		'parent_phone_number' => $req->parent_phone_number,
		'date_of_dischrge' => $req->date_of_dischrge,
		'hospcode_treat' => $req->hospcode_treat,
		'patient_type' => $req->patient_type,
		'patient_tube' => $req->patient_tube,
		...
		'gcs_m' => $req->gcs_m,
		'gcs_v' => $req->gcs_v,
		'pupils_l' => $req->pupils_l,
		'pupils_r' => $req->pupils_r,
		'physical_examination' => $req->physical_examination,
		'neurological_examination' => $req->neurological_examination,
		'J80' => $req->J80,
		'U07_1' => $req->U07_1,
		'I40' => $req->I40,
		'I30' => $req->I30,
		...
		'I77_6' => $req->I77_6,
		'L95' => $req->L95,
		'other_immune_mediated' => $req->other_immune_mediated,
		'I80_2' => $req->I80_2,
		'I26' => $req->I26,
		'T69_1' => $req->T69_1,
		'last_diagnosis' => $req->last_diagnosis,
		'text_last_diagnosis' => $req->text_last_diagnosis,
		'hospcode_treat1' => $req->hospcode_treat1,
		'text_hospcode_treat' => $req->text_hospcode_treat,
		'CXR' => $req->CXR,
		'CXR_date' => $req->CXR_date,
		'CXR_results' => $req->CXR_results,
		'CT' => $req->CT,
		'CT_body_organs' => $req->CT_body_organs,
		'CT_date' => $req->CT_date,
		'CT_results' => $req->CT_results,
		'MRI' => $req->MRI,
		'MRI_body_organs' => $req->MRI_body_organs,
		'MRI_date' => $req->MRI_date,
		'MRI_results' => $req->MRI_results,
		'EKG' => $req->EKG,
		'EKG_date' => $req->EKG_date,
		'EKG_results' => $req->EKG_results,
		'first_CBC' => $req->first_CBC,
		'first_CBC_Hct' => $req->first_CBC_Hct,
		'first_CBC_WBC' => $req->first_CBC_WBC,
		'first_CBC_Neu' => $req->first_CBC_Neu,
		'first_CBC_Lymp' => $req->first_CBC_Lymp,
		'first_CBC_Mono' => $req->first_CBC_Mono,
		'first_CBC_Eo' => $req->first_CBC_Eo,
		'first_CBC_Baso' => $req->first_CBC_Baso,
		'first_CBC_Plt_count' => $req->first_CBC_Plt_count,
		'first_blood_bhemistry_Hct' => $req->first_blood_bhemistry_Hct,
		'first_blood_bhemistry_WBC' => $req->first_blood_bhemistry_WBC,
		'first_blood_bhemistry_Neu' => $req->first_blood_bhemistry_Neu,
		'first_blood_bhemistry_Lymp' => $req->first_blood_bhemistry_Lymp,
		'first_blood_bhemistry_Mono' => $req->first_blood_bhemistry_Mono,
		'first_blood_bhemistry_Eo' => $req->first_blood_bhemistry_Eo,
		'first_blood_bhemistry_Baso' => $req->first_blood_bhemistry_Baso,
		'first_blood_bhemistry_Plt_count' => $req->first_blood_bhemistry_Plt_count,
		'cholesterol' => $req->cholesterol,
		'triglyceride' => $req->triglyceride,
		'HDL' => $req->HDL,
		'LDL' => $req->LDL,
		'PTT' => $req->PTT,
		'PT' => $req->PT,
		'TT' => $req->TT,
		'Coagulogram_other' => $req->Coagulogram_other,
		'CSF' => $req->CSF,
		'CSF_date' => $req->CSF_date,
		'CSF_nature' => $req->CSF_nature,
		'CSF_PMN' => $req->CSF_PMN,
		'CSF_Lymp' => $req->CSF_Lymp,
		'CSF_Protein' => $req->CSF_Protein,
		'CSF_sugar' => $req->CSF_sugar,
		'CSF_other' => $req->CSF_other,
		'NPS' => $req->NPS,
		'NPS_date' => $req->NPS_date,
		'NPS_PCR' => $req->NPS_PCR,
		'NPS_lab' => $req->NPS_lab,
		'Serum_COVID_19_IgM' => $req->Serum_COVID_19_IgM,
		'Serum_COVID_19_IgM1_date' => $req->Serum_COVID_19_IgM1_date,
		'Serum_COVID_19_IgM1_PCR' => $req->Serum_COVID_19_IgM1_PCR,
		'Serum_COVID_19_IgM2_lab' => $req->Serum_COVID_19_IgM2_lab,
		'Serum_COVID_19_IgM2_date' => $req->Serum_COVID_19_IgM2_date,
		'Serum_COVID_19_IgM2_PCR' => $req->Serum_COVID_19_IgM2_PCR,
		'Serum_COVID_19_IgM2_lab1' => $req->Serum_COVID_19_IgM2_lab1,
		'Serum_COVID_19_IgG' => $req->Serum_COVID_19_IgG,
		'Serum_COVID_19_IgG1_date' => $req->Serum_COVID_19_IgG1_date,
		'Serum_COVID_19_IgG1_PCR' => $req->Serum_COVID_19_IgG1_PCR,
		'Serum_COVID_19_IgG2_lab' => $req->Serum_COVID_19_IgG2_lab,
		'Serum_COVID_19_IgG2_date' => $req->Serum_COVID_19_IgG2_date,
		'Serum_COVID_19_IgG2_PCR' => $req->Serum_COVID_19_IgG2_PCR,
		'Serum_COVID_19_IgG2_lab1' => $req->Serum_COVID_19_IgG2_lab1,
		'other_examination' => $req->other_examination,
		'other_date_examination' => $req->other_date_examination,
		'other_saple_type' => $req->other_saple_type,
		'other_method' => $req->other_method,
		'other_examination_results' => $req->other_examination_results,
		'other_lab' => $req->other_lab,
		'covid19' => $req->covid19,
		'othercovid19' => $req->othercovid19,
		'inspect_covid' => $req->inspect_covid,
		'inspect_covid_results' => $req->inspect_covid_results,
		'inspect_covid_location' => $req->inspect_covid_location,
		'inspect_covid_date' => $req->inspect_covid_date,
		'covid_close_contact' => $req->covid_close_contact,
		'contact_nature' => $req->contact_nature,
		'other_contact_nature' => $req->other_contact_nature,
		'drug_allergy' => $req->drug_allergy,
		'drug_allergy_name' => $req->drug_allergy_name,
		'allergic_vaccines' => $req->allergic_vaccines,
		'allergic_vaccines_name' => $req->allergic_vaccines_name,
		'allergy' => $req->allergy,
		'detail_allergy' => $req->detail_allergy,
		'username_reporter' => auth()->user()->username,
		'province_reporter' => auth()->user()->prov_code,
		'region_reporter' => auth()->user()->region,
		'hospital_reporter' => auth()->user()->hospcode,
...
if ($update){
$msg = " ส่งข้อมูลสำเร็จ";
$url_rediect = "<script>alert('".$msg."'); window.location='EditAESI1?id_case=".$req->id_case."';</script> ";
}else{
$msg = " ส่งข้อมูลสำเร็จ";
$url_rediect = "<script>alert('".$msg."'); window.location='EditAESI1?id_case=".$req->id_case."';</script> ";
}
