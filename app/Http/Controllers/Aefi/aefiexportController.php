...
class aefiexportController extends Controller
{
	public $result;
	...
	public function index(){
		...
		return view('AEFI.Apps.aefiexport',
			[
    ...
    // dd($selectdata);
    return Excel::download(new $selectdata, 'aefi'.$date_of_symptoms_from.'_'.$date_of_symptoms_from.'.xlsx');
	}
