<?php
	...
	class UpdateController extends Controller
	{
		...
		public function updateform1(Request $req) {
			$delete1 = DB::table('aefi_form_1')->where('id_case','=', $req->id_case)->delete();
			if ($delete1) {
					$data =
					[
					'id_case' => $req->id_case,
					...
					$update	= DB::table('aefi_form_1')->insert($data);
			}
		if ($update) {
						$delete2 = DB::table('aefi_form_1_vac')->where('id_case','=', $req->id_case)->delete();
		}
		if ($update) 	 {
