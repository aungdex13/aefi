...
use DB;
class ExpertDiagController extends Controller
{
	public $result;
	...
	public function ExpertDiagLst(Request $req)
	{
	$id_case = $req->id_case;
	$selectaeficase= DB::table('aefi_form_1')
												->select(		'aefi_form_1.first_name',
	...
	$selectexpertcase= DB::table('expertmeeting')
												...
												->get();
												// dd($selectexpertcase);
	 return view('AEFI.Apps.ExpertDiagLst',compact(
		'id_case',
		'selectexpertcase',
		'selectaeficase'
	));
	...
	public function ExpertDiagFrm(Request $req)
	{
	$id_case = $req->id_case;
