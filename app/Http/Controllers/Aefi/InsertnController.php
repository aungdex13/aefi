<?php
	...
	class InsertnController extends Controller
	{
 ...
 $data_vac[]  = [
		...
		//  $res2= $data_vac;
		 $res2= DB::table('aefi_form_1_vac')->insert($data_vac);
											...
											if ($res2) {
												$msg = " ส่งข้อมูลสำเร็จ";
												$url_rediect = "<script>alert('".$msg."'); window.location='lstf1n';</script> ";
											}else{
												$msg = " ส่งข้อมูลไม่สำเร็จ";
												$url_rediect = "<script>alert('".$msg."'); window.location='form1n';</script> ";
														}
												echo $url_rediect;
