...
if (! function_exists('provinces')) {
  ...
  if (! function_exists('load_causality')) {
      ...
      $causality = array(
        ...
        '7'=>'ยังไม่สามารถสรุปได้ว่าเกี่ยวข้องกับวัคซีน (Indeterminate event)',
        '8'=>'ข้อมูลยังไม่เพียงพอที่จะสรุป (Unclassifiable event)',
        '9'=>'ให้ผู้เกี่ยวข้องติดตามข้อมูลเพิ่มเติมเพื่อนำเข้าพิจารณาใหม่ (Follow-up)',
        ''=>'NULL'
                              );
      return 	$causality;
      }
